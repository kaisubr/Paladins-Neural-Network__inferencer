...
class ObjectDetectorDetectionAPI(ObjectDetector.ObjectDetector): # or alternatively: from ObjectDetector import ObjectDetector; then use ObjectDetector for extending this class.
    def __init__(self, PATH_TO_FROZEN_GRAPH, PATH_TO_LABELS, NUM_CLASSES):
        graph_path = PATH_TO_FROZEN_GRAPH
        """
